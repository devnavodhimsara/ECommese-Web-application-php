...
?>
    ...
    <head>
        ...
        <title>User Profile | Nimsara Computers</title>
                        ...
                        <div class="profile-body ">
                            <div class="row">
                                <div class="col-md-3 text-center profile-img">
                                    ...
                                    <div class="row"> <span class="fw-bold text-dark"><?php echo $user_details["first_name"]; ?></span>
                                    ...
                                    <div class="p-3">
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12 d-grid mt-4">
                                                <button class="btn btn-outline-info btn btn-secondary" onclick="userupdateProfile();">Update My Profile</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
