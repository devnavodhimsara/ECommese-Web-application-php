    ...
    <div class="container-fluid">
        <div class="row">
                                                ...
                                                <div class="card mx-0 mx-lg-3 my-3" style="max-width: 540px;">
                                                    <div class="row g-0">
                                                        ...
                                                        WHERE `products`.`id`='" . $invoice_data["products_id"] . "'");
                                                            ...
                                                            <img src="<?php echo $product_data["path"]; ?>" class="img-thumbnail rounded-start mt-3" />
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-text"><b>Seller : </b>
                                                                    <?php echo $product_data["first_name"] . " " . $product_data["last_name"]; ?>
                                                                </p>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9">
                                                                <input type="text" class="form-control" disabled id="mail" value="<?php echo $_SESSION['u']['email']; ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-outline-primary" onclick="saveFeedback(<?php echo $invoice_data['products_id']; ?>);">Save Feedback</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php
                ...
                echo '<div class="col-12 text-center bg-body" style="height: 450px;">
                        <span class="fs-1 fw-bold text-black-50 d-block" style="margin-top: 200px;">
