...
<head>
  ...
  <title>NIMSARA COMPUTERS - Admin singin</title>
  ...
  <div class="row justify-content-center">
      ...
      <div class="card">
        <div class="card-header">
          <h1 class="title01" >admin loging <a href="aply_admins.php">  <button class="btn btn-danger"  type="button">Dont have an account register now</button></a></h1>
        </div>
        <div class="card-body">
          ...
          <form>
            ...
            <center><a href="#" class="mt-2 " onclick="forgotPassword2();">Forgot Password ?</a></center>
            <div class="d-grid gap-2">
              <button class="btn btn-primary" type="button" onclick="adminsingin();">Log now</button>
            </div>
          </form>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Forgot Password Nimsara Computers</h5>
