    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="text-center">
                ...
                <a href="indexlk.php" class="btn btn-outline-info fs-3 fw-bold">Start Shopping</a>
            </div>
        <?php
        } else {
            $col_size = 6; // Set column size to 6 for 2 products per row
            $row_count = 0;
        ...
        ?>
                ...
                <div class="col-md-<?php echo $col_size; ?>">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mt-3">Requested Total: <span class="text-success"><?php echo ($product_data["price"] * $cart_data["qty"]); ?></span></p>
                        </div>
                    </div>
                </div>
                ...
                <?php if ($row_count % 2 == 0 || $row_count == $cart_num) { ?>
                    </div>
                <?php } ?>
        <?php
            }
        ...
        <div class="summary-card mt-4">
            ...
            <button class="btn btn-primary fs-5 mt-3" onclick="checkuout();"><span class="fw-bold fs-3 text-white"><i class="bi bi-hand-index-thumb"></i> Check Out</span></button>
        </div>
    </div>
