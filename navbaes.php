...
<head>
  ...
  <link rel=""gegdcxwihefdciuwiaqdcxoijiohjiehwqihdcxiuhwuecjwhfcuwauicuj
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active text-white d-grid" aria-current="page" href="dashboard.php">Dashboard</a>
          </li>
          <li class="nav-item">
        ...
        <button type="button" class="btn btn-info"> <a class="link-secondary text-decoration-none" type="button"  onclick="submit();"> buyer</a> </button>
          <?php if( isset($_SESSION["sup"])){
            $datas = $_SESSION["sup"];{?>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="seller profile.php">my profile</a></li>
                <li>
            ...
            <li class="nav-item d-grid">
              <a class="nav-link text-white" href="sellersingin.php">Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white d-grid" href="sellersingup.php">register</a>
            </li>
          <?php } ?>
        </ul>
