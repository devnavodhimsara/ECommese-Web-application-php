    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12  text-center py-3">
                <label class="form-label text-primary fw-bold fs-1">manege users Nimsaracomputers</label>
            </div>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="form-check-label fw-bold text-info" for="toggle<?php echo $selected_data["id"]; ?>">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="toggle<?php echo $selected_data["id"]; ?>" onchange="changeStatususer(<?php echo $selected_data['id']; ?>);" <?php if ($selected_data["status"] == 2) { ?> checked <?php } ?> />
