    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12  text-center py-3">
                <label class="form-label text-primary fw-bold fs-1">manege sellers Nimsaracomputers</label>
            </div>
            <div class="col-12 mt-3">
                <form class="row mb-3" method="GET">
                    ...
                    $selected_rs = Database::search("SELECT * FROM `users` WHERE `email`='" . $_SESSION["admin"]["email"] . "'");
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['search'])) {
                                        $search = $_GET['search'];
                                        $query .= " WHERE `first_name` LIKE '%$search%' OR `email` LIKE '%$search%'";
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $selected_data["first_name"]; ?></td>
                                                <td><?php echo $selected_data["last_name"]; ?></td>
                                                <td><img src="<?php echo $selected_data['profile_image']; ?>" alt="User Profile" class="rounded-circle" width="50" height="50" onerror="this.src='AUTOMATED FUTURE.png'"></td>
                                                ...
                                                <td class="form-check-label fw-bold text-info" for="toggle<?php echo $selected_data["id"]; ?>">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="toggle<?php echo $selected_data["id"]; ?>" onchange="changeStatusseller(<?php echo $selected_data['id']; ?>);" <?php if ($selected_data["status"] == 2) { ?> checked <?php } ?> />
                                                    <?php if ($selected_data["status"] == 1) { ?>
                                                        make seller deactive
                                                    <?php } else { ?>
                                                        Make seller Active
                                                    <?php } ?>
                                                </td>
