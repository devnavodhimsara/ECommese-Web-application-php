...
<head>
  ...
  <title>NIMSARA COMPUTERS - Login</title>
  ...
  <div class="row justify-content-center">
    ...
    <div class="card">
      <div class="card-header">
        <h1 class="title01">user loging <a href="index.php"> <button class="btn btn-danger" type="button">Dont have an account register now</button></a></h1>
      </div>
      <div class="card-body">
        ...
        <form>
          ...
          <div class="d-grid gap-2">
            <button class="btn btn-primary" type="button" onclick="singin();">Log now</button>
          </div>
        </form>
