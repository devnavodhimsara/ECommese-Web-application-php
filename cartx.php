                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    for ($x = 0; $x < $cart_num; $x++) {
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `products` INNER JOIN `product_images` ON 
                                        products.id=product_images.product_id WHERE `id`='" . $cart_data["product_id"] . "'");
                                    ...
                                    city.district_district_id=district.district_id WHERE `users_id`='" . $user . "'");
                                        ...
                                        $seller_rs = Database::search("SELECT * FROM `users` WHERE `id`='" . $product_data["users_id"] . "'");
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="number" class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" value="<?php echo $cart_data["qty"]; ?>" onchange="changeQTY(<?php echo $cart_data['id']; ?>);" id="qty_num-<?php echo $cart_data['id']; ?>">
                                                        <br><br>
